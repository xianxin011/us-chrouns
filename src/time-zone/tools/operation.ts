...
import {getESTDate,getWorldTimeZone} from '../index'

import { DEFAULT_OPTIONS, week } from '../types/enum'
...
export const UTC_getDate = (datePara?: _Date) =>
  datePara ? new Date(datePara as _Date).getUTCDate() : new Date().getUTCDate();
export const UTC_getHours = (datePara?: _Date) =>
  datePara ? new Date(datePara as _Date).getUTCHours() : new Date().getUTCHours();
export const UTC_getMinutes = (datePara?: _Date) =>
  datePara ? new Date(datePara as _Date).getUTCMinutes() : new Date().getUTCMinutes();
export const UTC_getSeconds = (datePara?: _Date) =>
  datePara ? new Date(datePara as _Date).getUTCSeconds() : new Date().getUTCSeconds();
